...
class WindroseAxes(PolarAxes):
    ...
    def _init_plot(self, direction, var, **kwargs):
        ...
        self._info['dir'], self._info['bins'], self._info['table'] = histogram(direction, var, bins, nsector, normed, log, blowto)
...
def histogram(direction, var, bins, nsector, normed=False, log=False, blowto=False):
    """
